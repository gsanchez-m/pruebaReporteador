...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_35 = NL + "String dbschema_";
  protected final String TEXT_36 = " =\"\";";
  protected final String TEXT_37 = NL + "java.sql.Connection conn_";
  protected final String TEXT_38 = " = null;";
  protected final String TEXT_39 = NL + "String dbUser_";
  protected final String TEXT_40 = NL + "\tdbschema_";
  protected final String TEXT_41 = " = ";
  protected final String TEXT_42 = ";" + NL + "\t";
  protected final String TEXT_43 = " = (String)globalMap.get(\"";
  ...
  protected final String TEXT_48 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_49 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_50 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_51 = ".get(dsAlias_";
  protected final String TEXT_52 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_53 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_54 = " = dataSources_";
  protected final String TEXT_55 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_56 = NL + "    dbschema_";
  protected final String TEXT_57 = ";";
  protected final String TEXT_58 = NL + "    String driverClass_";
  protected final String TEXT_59 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_60 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_61 = NL + "\t";
  protected final String TEXT_62 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_63 = ");" + NL + "    String port_";
  protected final String TEXT_64 = ";" + NL + "    String dbname_";
  protected final String TEXT_65 = " ;";
  protected final String TEXT_66 = NL + "    String url_";
  protected final String TEXT_67 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_68 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_69 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_70 = ")) {" + NL + "    \turl_";
  protected final String TEXT_71 = " += \":\" + ";
  protected final String TEXT_72 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_73 = ")) {";
  protected final String TEXT_74 = NL + "\t\t\t\turl_";
  protected final String TEXT_75 = " += \"//\" + ";
  protected final String TEXT_76 = "; " + NL + "\t";
  protected final String TEXT_77 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_78 = " += \";databaseName=\" + ";
  protected final String TEXT_79 = NL + "    }" + NL + "    url_";
  protected final String TEXT_80 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_81 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_95 = NL + "//java.sql.Statement stmt_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".createStatement();" + NL + "" + NL + "//stmt_";
  protected final String TEXT_98 = ".execute(\"SET NOCOUNT ON\");" + NL + "String spSchema_";
  protected final String TEXT_99 = " = \"\";" + NL + "if(dbschema_";
  protected final String TEXT_100 = " != null && !dbschema_";
  protected final String TEXT_101 = ".trim().isEmpty()) {" + NL + "    spSchema_";
  protected final String TEXT_102 = " = \"[\"+dbschema_";
  protected final String TEXT_103 = "+\"].\";" + NL + "}" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_104 = ".prepareCall(\"{";
  protected final String TEXT_105 = "call \" + spSchema_";
  protected final String TEXT_106 = " + ";
  protected final String TEXT_107 = " + \"(";
  protected final String TEXT_108 = ")}\"";
  protected final String TEXT_109 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_110 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_111 = ";" + NL + "String tmpString_";

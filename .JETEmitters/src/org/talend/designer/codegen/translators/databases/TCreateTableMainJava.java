...
public class TCreateTableMainJava
{
  ...
  protected final String TEXT_63 = " - Creating table '\" + tableName_";
  protected final String TEXT_64 = " + \"'.\");";
  protected final String TEXT_65 = NL + "            stmt_";
  protected final String TEXT_66 = ".execute(\"";
  protected final String TEXT_67 = "\");";
  protected final String TEXT_68 = " - Create table '\" + tableName_";
  protected final String TEXT_69 = " + \"' has succeeded.\");";
  protected final String TEXT_70 = NL + "            boolean whetherExist_";
  protected final String TEXT_71 = " = false;";
  protected final String TEXT_72 = NL + "\t\t\t\t";
  protected final String TEXT_73 = NL + "\t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_74 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_75 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_76 = " = tableNameForSearch_";
  protected final String TEXT_77 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  ...
  protected final String TEXT_82 = ", new String[]{\"TABLE\"});" + NL + "\t            if(rsTable_";
  protected final String TEXT_83 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_84 = " = true;" + NL + "\t            }     ";
  ...
  protected final String TEXT_87 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_92 = ".equals";
  protected final String TEXT_93 = "IgnoreCase";
  protected final String TEXT_94 = "(";
  protected final String TEXT_95 = ") " + NL + "                        && (schema_";
  protected final String TEXT_96 = "(dbSchema_";
  protected final String TEXT_97 = ") || (dbSchema_";
  protected final String TEXT_98 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_99 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_100 = ")))) {" + NL + "                        whetherExist_";
  protected final String TEXT_101 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }";
  protected final String TEXT_102 = NL + "                    java.sql.PreparedStatement tempTablePs_";
  protected final String TEXT_103 = ".prepareStatement(\"SELECT * FROM information_schema.tables WHERE table_type='LOCAL TEMPORARY' AND table_name = ?\");" + NL + "                    tempTablePs_";
  protected final String TEXT_104 = ".setString(1, ";
  protected final String TEXT_105 = ");" + NL + "                    java.sql.ResultSet rsTable_";
  protected final String TEXT_106 = " = tempTablePs_";
  protected final String TEXT_107 = ".executeQuery();" + NL + "                    whetherExist_";
  protected final String TEXT_108 = ".next();";
  ...
  protected final String TEXT_111 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                    String defaultSchema_";
  protected final String TEXT_112 = " = \"public\";" + NL + "                    if(dbSchema_";
  protected final String TEXT_113 = " == null || dbSchema_";
  protected final String TEXT_114 = ".trim().length() == 0) {" + NL + "                        java.sql.Statement stmtSchema_";
  protected final String TEXT_115 = ".createStatement();" + NL + "                        java.sql.ResultSet rsSchema_";
  protected final String TEXT_116 = " = stmtSchema_";
  protected final String TEXT_117 = ".executeQuery(\"select current_schema() \");" + NL + "                        while(rsSchema_";
  protected final String TEXT_118 = ".next()){" + NL + "                            defaultSchema_";
  protected final String TEXT_119 = " = rsSchema_";
  protected final String TEXT_120 = ".getString(\"current_schema\");" + NL + "                        }" + NL + "                        rsSchema_";
  protected final String TEXT_121 = ".close();" + NL + "                        stmtSchema_";
  protected final String TEXT_122 = ".close();" + NL + "                    }" + NL + "                    while(rsTable_";
  ...
  protected final String TEXT_129 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_130 = "(schema_";
  protected final String TEXT_131 = ")))) {" + NL + "                            whetherExist_";
  protected final String TEXT_132 = " = true;" + NL + "                            break;" + NL + "                        }" + NL + "                    }";
  protected final String TEXT_133 = NL + "                java.sql.Statement rsTable_";
  protected final String TEXT_134 = ".createStatement();" + NL + "                try {" + NL + "                    rsTable_";
  ...
  protected final String TEXT_141 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            while(rsTable_";
  ...
  protected final String TEXT_148 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + NL;
  protected final String TEXT_149 = NL + "\t\t\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_153 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_158 = "(dbname_";
  protected final String TEXT_159 = ") || (dbname_";
  protected final String TEXT_160 = ")))) {" + NL + "\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_161 = " = true;" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL;
  protected final String TEXT_162 = ".getTables(conn_";
  protected final String TEXT_163 = ".getCatalog(), conn_";
  protected final String TEXT_164 = ".getSchema(),(";
  protected final String TEXT_165 = ")";
  protected final String TEXT_166 = ", new String[] { \"TABLE\" });" + NL + "\t            if(rsTable_";
  protected final String TEXT_167 = ".next()) {" + NL + "\t                whetherExist_";
  protected final String TEXT_168 = ".getTables(";
  protected final String TEXT_169 = ", null, null, new String[]{\"TABLE\"});" + NL + "                while(rsTable_";
  protected final String TEXT_170 = ".getString(\"TABLE_NAME\");" + NL + "                    if(table_";
  protected final String TEXT_171 = ")) {" + NL + "                        whetherExist_";
  protected final String TEXT_172 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }  ";
  protected final String TEXT_173 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_174 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_175 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }     ";
  protected final String TEXT_176 = NL + "            rsTable_";
  protected final String TEXT_177 = ".close();";
  protected final String TEXT_178 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_186 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_187 = " - Droping table '\" + tableName_";
  protected final String TEXT_188 = NL + "                    stmtDrop_";
  protected final String TEXT_189 = " - Drop table '\" + tableName_";
  protected final String TEXT_190 = NL + "                }" + NL + "                java.sql.Statement stmt_";
  ...
  protected final String TEXT_196 = "_QUERY\", \"";
  protected final String TEXT_197 = "\");        " + NL + "    } catch(java.lang.Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_198 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        throw new RuntimeException(\"Creating table failed\", e);" + NL + "    }";

...
public class TSOAPMainJava
{
  ...
  protected final String TEXT_45 = ");" + NL + "\t\t\t\t\t}catch(java.lang.Exception ex){" + NL + "\t\t\t\t\t\tex.printStackTrace();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\treturn null;" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\tpublic Object run(){" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tsoapUtil_";
  protected final String TEXT_47 = ".invokeSOAP(org.talend.soap.SOAPUtil.";
  protected final String TEXT_48 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_49 = NL + "\t\t\tfinal String soapVersion_";
  protected final String TEXT_50 = " = org.talend.soap.SOAPUtil.SOAP12;" + NL + "\t\t";
  protected final String TEXT_51 = " = org.talend.soap.SOAPUtil.SOAP11;" + NL + "\t\t";
  protected final String TEXT_52 = NL + "\t\tjavax.security.auth.Subject subject_";
  protected final String TEXT_53 = " = (javax.security.auth.Subject)globalMap.get(\"kerberos_subject_";
  protected final String TEXT_54 = "\");" + NL + "\t\tif(subject_";
  protected final String TEXT_55 = "==null){" + NL + "\t\t\tSystem.err.println(\"Subject for Kerberos is null!\");" + NL + "\t\t\t";
  protected final String TEXT_56 = NL + "\t\tTalendPrivilegedAction talendPrivilegedAction_";
  protected final String TEXT_57 = " = new TalendPrivilegedAction(";
  protected final String TEXT_58 = "soapVersion_";
  protected final String TEXT_59 = ");" + NL + "\t\tjavax.security.auth.Subject.doAs(subject_";
  protected final String TEXT_60 = ",talendPrivilegedAction_";
  protected final String TEXT_61 = ");" + NL + "\t\t";
  protected final String TEXT_62 = NL + "\t\t";
  protected final String TEXT_63 = NL + "\t\t\tString document_";
  protected final String TEXT_64 = " = talendPrivilegedAction_";
  protected final String TEXT_65 = ".document;" + NL + "\t\t";
  protected final String TEXT_66 = NL + "\t";
  protected final String TEXT_67 = " = soapUtil_";
  protected final String TEXT_68 = NL + "\t\t\tsoapUtil_";
  protected final String TEXT_69 = NL + NL + "\t// for output" + NL + "\t";
  protected final String TEXT_70 = "\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_71 = " = new ";
  protected final String TEXT_72 = "Struct();" + NL + "\t\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\t\t";
  protected final String TEXT_74 = ".Soap = ParserUtils.parseTo_Document(document_";
  protected final String TEXT_75 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_76 = ".Header = soapUtil_";
  protected final String TEXT_77 = ".getReHeaderMessage();" + NL + "\t\t\t\t\tif(soapUtil_";
  protected final String TEXT_78 = ".hasFault()){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_79 = ".Fault = soapUtil_";
  protected final String TEXT_80 = ".getReFaultMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_81 = ".Body = soapUtil_";
  protected final String TEXT_82 = ".getReBodyMessage();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";

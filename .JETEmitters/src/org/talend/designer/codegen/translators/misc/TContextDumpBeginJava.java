...
public class TContextDumpBeginJava
{
  ...
  protected final String TEXT_13 = ".toString());" + NL + "            if(NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY.equals(value_";
  protected final String TEXT_14 = ")) {" + NL + "            \tvalue_";
  protected final String TEXT_15 = " = \"\";//keep the same result for parent and child job" + NL + "            }";
  protected final String TEXT_16 = NL + "                    ";
  protected final String TEXT_17 = ".";
  protected final String TEXT_18 = " = key_";
  protected final String TEXT_19 = ".toString();" + NL + "\t\t\t\t\t";
  protected final String TEXT_20 = NL + "\t\t\t\t\t\tif ((\"id_Password\").equals(context.getContextType(key_";
  protected final String TEXT_21 = ".toString()))) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_22 = " = value_";
  protected final String TEXT_23 = ".toString().replaceAll(\".\",\"*\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse " + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_28 = ".toString())){" + NL + "\t\t\t\t\t\t\t\tif(value_";
  protected final String TEXT_29 = ".toString().indexOf(\";\")>-1){" + NL + "\t\t\t                    \t";
  protected final String TEXT_30 = ".toString().substring(value_";
  protected final String TEXT_31 = ".toString().indexOf(\";\")+1);" + NL + "\t\t\t                    }" + NL + "\t\t\t                }" + NL + "\t\t\t\t\t\t";
